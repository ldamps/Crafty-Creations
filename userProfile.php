           ...
           <?php if (isset($_SESSION["LoggedIn"])): ?>
             <form id="personalInfoForm" method="POST" action="userProfile.php">
              <p><strong>Name:</strong> 
                <span id="nameDisplay"><?php echo $customerInfo['Title'] . ' ' . $customerInfo['FirstName'] . ' ' . $customerInfo['LastName']; ?></span>
                <input type="text" id="nameInput" name="name" value="<?php echo $customerInfo['Title'] . ' ' . $customerInfo['FirstName'] . ' ' . $customerInfo['LastName']; ?>" style="display:none;">
              </p>
              <p><strong>Email:</strong> 
                <span id="emailDisplay"><?php echo $customerInfo['EmailAddress']; ?></span>
                <input type="email" id="emailInput" name="email" value="<?php echo $customerInfo['EmailAddress']; ?>"style="display:none;" >
              </p>
              <p><strong>Phone:</strong> 
                <span id="phoneDisplay"><?php echo $customerInfo['PhoneNumber']; ?></span>
                <input type="text" id="phoneInput" name="phone" value="<?php echo $customerInfo['PhoneNumber']; ?>" style="display:none;">
              </p>
         ...
         <div class="section">
          <h2>Address</h2>
           ...
           <form id="addressForm<?php echo $i; ?>" method="POST" action="userProfile.php">
            ...
            <input type="hidden" id="addressID<?php echo $i; ?>" name="addressID" value="<?php echo $address['AddressID']?>"

            <p><strong>Street:</strong> 
                <span id="streetDisplay<?php echo $i; ?>"><?php echo $address['HouseNumber'] . ' ' . $address['StreetName']; ?></span>
                <input type="text" id="streetInput<?php echo $i; ?>" name="street" value="<?php echo $address['HouseNumber'] . ' ' . $address['StreetName']; ?>" style="display:none;">
            </p>
            <p><strong>City:</strong> 
                <span id="cityDisplay<?php echo $i; ?>"><?php echo $address['City']; ?></span>
                <input type="text" id="cityInput<?php echo $i; ?>" name="city" value="<?php echo $address['City']; ?>" style="display:none;">
            </p>
            <p><strong>Postcode:</strong> 
                <span id="postcodeDisplay<?php echo $i; ?>"><?php echo $address['Postcode']; ?></span>
                <input type="text" id="postcodeInput<?php echo $i; ?>" name="postcode" value="<?php echo $address['Postcode']; ?>" style="display:none;">
            </p>
