...
<body>
    <nav class="topnav">
        <a class="company" href="index.html">Crafty Creations</a>
        <ul>
            <img src="basketImage.svg" id="basketImage" class="button" href="#">
            <a id='logInText' class="button" href="#">log in | sign up</a>
        </ul>
    </nav>
